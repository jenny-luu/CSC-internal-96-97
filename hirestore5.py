...
def check_input():
    ...
    if len(entry_receipt.get()) == 0:
        Label(main_window, fg="red", text="Required",bg ="sky blue").grid(column=2, row=3,sticky =W)
        input_check = 1
...
def setup_buttons():
    ...
    Button(main_window, text="Quit",font="times 15 italic bold",command=quit,bg ="sky blue",
